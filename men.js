const getProductsAndPrice = function () {
  ...
  request.addEventListener('load', function () {
    ...
    // Define categories or keywords for men's wear, shoes, ties, and bags
    const targetCategories = ["men's clothing"]; // Adjust this based on the API
    const targetKeywords = ["shoe", "tie", "bag"];
